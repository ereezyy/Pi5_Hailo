...
export function DetectionHeatmap() {
  ...
  // ⚡ Bolt: Memoize class totals to prevent O(C*N) recalculation on every render
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {classes.map(cls => {
              // ⚡ Bolt: Use pre-computed class totals instead of O(N) filter and reduce inside render loop
